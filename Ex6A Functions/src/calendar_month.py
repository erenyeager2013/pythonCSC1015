...
def num_weeks(month_num, year):
    ...
    month_days = num_days_in(month_num, year)

    # Calculate the day of the week the month starts on (1 for Monday, 7 for Sunday)
    start_day_of_month = day_of_week(1, month_num, year)

    # Calculate the number of weeks
    if month_days % 7 != 0:
        if start_day_of_month > 6 and month_days> 29:
            return 6
        elif start_day_of_month > 5 and month_days ==31 :
            return 6
        elif start_day_of_month > 5 and month_days == 30:
            return 5
        else:
            return 5
